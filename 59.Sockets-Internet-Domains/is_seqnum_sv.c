...
#define ADDRSTRLEN (NI_MAXHOST + NI_MAXSERV + 10)
    ...
    hints.ai_addr = NULL;
		/*
			 ...
			 If node is NULL, then the network address will be set to the loopback interface address (INADDR_LOOPBACK
       for IPv4 addresses, IN6ADDR_LOOPBACK_INIT for IPv6 address); this is used by applications that intend to 
			 communicate with  peers  run-ning on the same host.
		*/
    hints.ai_next = NULL;
